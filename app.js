...
function addMapLegend() {
  ...
  legend.onAdd = () => {
    ...
    div.innerHTML = [
      ...
      '<br><span class="map-legend-dot" style="background:#a78bfa;border-radius:0"></span>🚶徒歩圏',
      '<br><span class="map-legend-dot" style="background:#38bdf8;border-radius:0"></span>🏃ジョギング圏',
      '<br><span class="map-legend-dot" style="background:#f59e0b;border-radius:0"></span>🚗車圏',
      '<hr style="border-color:rgba(255,255,255,0.15);margin:4px 0">',
