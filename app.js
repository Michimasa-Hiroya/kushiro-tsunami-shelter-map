...
function addMapLegend() {
  ...
  legend.onAdd = () => {
    ...
    div.innerHTML = [
      ...
      '<br><span class="map-legend-char">不</span>不明',
      '<br><span class="map-legend-char">空</span>空き',
      '<br><span class="map-legend-char">混</span>混雑(50%)',
      '<br><span class="map-legend-char">満</span>満室',
      '<hr style="border-color:rgba(255,255,255,0.15);margin:4px 0">',
